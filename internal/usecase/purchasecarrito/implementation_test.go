...
import (
	...
	mediosdepago "bubblegum-api/internal/domain/constants/medios_de_pago"
...
func TestWhenEverythingIsSuccesfullShouldReturnNewCarritoID(t *testing.T) {
	useCase := initialize()
...
func TestWhenCarritoWasNotFoundShouldReturnNotFoundError(t *testing.T) {
	...
	mockCarritosProvider.On("GetByID", command.CarritoID).Return(entities.Carrito{}, database.NewNotFoundError(errormessages.CarritoNotFound.String()))
...
func TestWhenGetCarritoWhentWrongShouldReturnInternalServerError(t *testing.T) {
	useCase := initialize()
	command := getMockCommand()

	mockCarritosProvider.On("GetByID", command.CarritoID).Return(entities.Carrito{}, database.NewInterlServerError(errormessages.InternalServerError.String()))
...
func TestWhenCarritoWasAlreadyPurchasedShouldReturnAlreadyPurchaseError(t *testing.T) {
	...
	assert.Error(t, err)
	assert.Equal(t, "business.CarritoAlreadyPurchaseError", typeErr)
	assert.Empty(t, carritoID)
	mockCarritosProvider.AssertNumberOfCalls(t, "GetByID", 1)
	mockUsuariosProvider.AssertNumberOfCalls(t, "GetByID", 0)
	mockCarritosProvider.AssertNumberOfCalls(t, "Save", 0)
...
func TestWhenUserWasNotFoundShouldReturnNotFoundError(t *testing.T) {
	...
	mockCarritosProvider.On("GetByID", command.CarritoID).Return(mockCarrito, nil)
	mockUsuariosProvider.On("GetByID", command.CompradorID).Return(entities.Usuario{}, database.NewNotFoundError(errormessages.UsuarioNotFound.String()))
...
func TestWhenGetUserWhentWrongShouldReturnInternalServerError(t *testing.T) {
	useCase := initialize()
	command := getMockCommand()
	...
	mockCarritosProvider.On("GetByID", command.CarritoID).Return(mockCarrito, nil)
	mockUsuariosProvider.On("GetByID", command.CompradorID).Return(entities.Usuario{}, database.NewInterlServerError(errormessages.InternalServerError.String()))
...
func TestWhenSaveUpdatedCarritoWhentWrongShouldReturnInternalServerError(t *testing.T) {
	useCase := initialize()
	command := getMockCommand()
	...
	mockCarritosProvider.On("GetByID", command.CarritoID).Return(mockCarrito, nil)
	mockUsuariosProvider.On("GetByID", command.CompradorID).Return(mockUsuario, nil)
	mockCarritosProvider.On("Save", &mockUpdatedCarrito).Return(uint64(0), database.NewInterlServerError(errormessages.InternalServerError.String()))
...
func TestWhenCreateVentasWhentWrongShouldReturnInternalServerError(t *testing.T) {
	useCase := initialize()
	command := getMockCommand()
	...
	mockUsuariosProvider.On("GetByID", command.CompradorID).Return(mockUsuario, nil)
	mockCarritosProvider.On("Save", &mockUpdatedCarrito).Return(uint64(0), nil)
	mockVentasProvider.On("Create", &mockVentaToCreate).Return(uint64(0), database.NewInterlServerError(errormessages.InternalServerError.String()))
...
func TestWhenSaveEmpyCarritoWentWrongThenShouldReturn(t *testing.T) {
	useCase := initialize()
	command := getMockCommand()
	...
	mockCarritosProvider.On("Save", &mockUpdatedCarrito).Return(uint64(0), nil)
	mockVentasProvider.On("Create", &mockVentaToCreate).Return(mockCarritoID, nil)
	mockCarritosProvider.On("Save", &mockEmptyCarrito).Return(uint64(0), database.NewInterlServerError(errormessages.InternalServerError.String()))
...
func TestWhenSaveUpdatedUserWentThenShouldReturnInternalServerError(t *testing.T) {
	useCase := initialize()
	command := getMockCommand()
	...
	mockVentasProvider.On("Create", &mockVentaToCreate).Return(mockCarritoID, nil)
	mockCarritosProvider.On("Save", &mockEmptyCarrito).Return(mockCarritoID2, nil)
	mockUsuariosProvider.On("Save", &mockUpdatedUsuario).Return(database.NewInterlServerError(errormessages.InternalServerError.String()))
